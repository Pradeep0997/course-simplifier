...
class ChangesFollower {
    ...
    createChangesResultItemsStream(mode) {
        ...
        let resultsIterator = node_stream_1.Readable.from((0, node_stream_1.pipeline)(node_stream_1.Readable.from(this.changesResultIterator), new stream_1.Stream(), () => { })).flatMap((item) => item.results);
